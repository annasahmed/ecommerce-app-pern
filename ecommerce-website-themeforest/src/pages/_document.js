		...
		return (
			<Html lang="en">
				<Head>
					...
					<meta
						property="og:title"
						content={setting?.meta_title || "eCom Store - E-commerce Template"}
					/>
					<meta property="og:type" content="eCommerce Website" />
					<meta
						property="og:description"
						content={setting?.meta_description || "E-commerce Template"}
					/>
					<meta
						name="keywords"
					...
					<meta
						property="og:url"
						content={
							setting?.meta_url || "https://ecom-store-gilt-nu.vercel.app/"
						}
					/>
					<meta
						property="og:image"
