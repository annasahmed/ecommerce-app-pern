			...
			<AnimatedContent>
				...
				<div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
					<CardItem
						...
						loading={false}
						quantity={0}
						className="text-customOrange-600 dark:text-orangecustom-100 bg-customOrange-100 dark:bg-customOrange-500"
					/>
					<CardItem
				...
				{/* <div className="grid gap-4 md:grid-cols-2 my-8">
					<ChartCard mode={mode} loading={false} title={t("WeeklySales")}>
