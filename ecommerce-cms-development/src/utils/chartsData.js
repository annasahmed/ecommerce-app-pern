export const doughnutLegends = [
	{ title: "Fresh Vegetable", color: "bg-customTeal-500" },
	{ title: "Cooking Essentials", color: "bg-customBlue-500" },
	{ title: "Drinks", color: "bg-customOrange-500" },
	{ title: "Organic Food", color: "bg-customBlue-600" },
];

export const lineLegends = [
	{ title: "Organic", color: "bg-customTeal-600" },
