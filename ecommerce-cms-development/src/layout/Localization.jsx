	...
	return (
		<>
			<MainDrawer>
				...
				{title === "Currencies" && <CSSContainerRulerencyDrawer />}
			</MainDrawer>
			...
			<Card className="min-w-0 shadow-xs overflow-hidden bg-customWhite dark:bg-customGray-800 dark:text-customGray-400 mb-5">
				<CardBody>
