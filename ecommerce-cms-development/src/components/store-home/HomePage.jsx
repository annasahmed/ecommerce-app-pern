		...
		<>
			...
			<div className="grid grid-cols-12 font-sans pr-4">
				...
				<div className="col-span-12 md:col-span-12 lg:col-span-12">
					<div className="inline-flex md:text-lg text-base text-customGray-800 font-semibold dark:text-customGray-400 mb-3">
					...
					<div className="flex-grow scrollbar-hide w-full max-h-full xl:px-10">
						<div className="inline-flex md:text-base text-sm my-3 text-customGray-500 dark:text-customGray-400">
					...
					<div className="grid md:grid-cols-5 sm:grid-cols-6 scrollbar-hide w-full max-h-full pb-0">
						...
						<div className="sm:col-span-4 md:pl-3 sm:pl-2">
							<div className="inline-flex md:text-base text-sm mb-3 text-customGray-500 dark:text-customGray-400 relative">
							...
							<div className="grid xl:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
								<div>
									<h4 className="font-medium font-serif md:text-base text-sm mb-2 dark:text-customGray-300">
										{t("Categories")}
									</h4>
									...
									<div className="grid md:grid-cols-3 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
										<div>
											<div className="relative">
												<h4 className="font-medium md:text-base text-sm mb-2 dark:text-customGray-400">
													{" "}
													{t("LeftRighArrows")}
												</h4>
											</div>
				...
				<div className="col-span-12 md:col-span-12 lg:col-span-12 mt-5">
					...
					<div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full">
						...
						<div
							...
							<div>
								<div className="inline-flex md:text-base text-sm mb-3 text-customGray-500 dark:text-customGray-400">
									<div className="relative">
							...
							{!isSliderFullWidth && !isCoupon && (
								<div>
									<div className="inline-flex md:text-base text-sm mb-3 text-customGray-500 dark:text-customGray-400 mt-5 ">
										<div className="relative">
									...
									<div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mt-4 md:mb-6 mb-3 pb-2">
										...
										<div className="sm:col-span-4">
											...
											/>
											<div className="text-xs text-center text-customGray-400">
				...
				{/*  ====================================================== Promotion Banner ===================================================== */}
				<div className="col-span-12 md:col-span-12 lg:col-span-12">
					<div className="inline-flex md:text-lg text-base text-customGray-800 font-semibold dark:text-customGray-400 mb-3 md:mt-0 mt-10">
							...
							<div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
								...
								<div className="sm:col-span-4">
									<InputAreaTwo
										...
										type="text"
										placeholder="https://ecom-store-gilt-nu.vercel.app/search?category=fruits-vegetable&_id=632aca2b4d87ff2494210be8"
									/>
				...
				<div className="col-span-12 md:col-span-12 lg:col-span-12 md:mt-0 mt-15">
					<div className="inline-flex md:text-lg text-base text-customGray-800 font-semibold dark:text-customGray-400 mb-3 relative">
				...
				<div className="col-span-12 md:col-span-12 lg:col-span-12 md:mt-0 mt-10">
					...
					<div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full pb-0">
						...
						<div className="inline-flex md:text-base text-sm mb-3 text-customGray-500 dark:text-customGray-400 relative md:mt-0 mt-24">
						...
						<div className="inline-flex md:text-base text-sm mb-3 text-customGray-500 dark:text-customGray-400 relative mt-24 md:mt-0">
                  ...
                  <div className="sm:col-span-4">
                    ...
                    />
						...
						<div className="inline-flex md:text-base text-sm mb-3 text-customGray-500 dark:text-customGray-400 relative mt-16 md:mt-0">
