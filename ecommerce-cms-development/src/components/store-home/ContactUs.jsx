		...
		<>
			<div className="col-span-12 md:col-span-12 lg:col-span-12 pr-3">
				...
				<div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full">
					<div className="inline-flex md:text-md text-sm mb-3 text-customGray-500 dark:text-customGray-400">
					...
					<div className="inline-flex md:text-md text-sm mb-3 text-customGray-500 dark:text-customGray-400 relative">
