		...
		<>
			<div className="grid grid-cols-12 font-sans pr-4">
				<div className="col-span-12 md:col-span-12 lg:col-span-12">
					...
					<div className="inline-flex md:text-lg text-base text-customGray-800 font-semibold dark:text-customGray-400 md:mb-3 mb-1">
					...
					<div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full">
						...
						<div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
							<label className="block md:text-sm md:col-span-1 sm:col-span-2 text-xs font-semibold text-customGray-600 dark:text-customGray-400 md:mb-1">
								{t("EnableThisBlock")}
							</label>
						...
						<div className="inline-flex md:text-base text-sm mb-3 mt-5 text-customGray-500 dark:text-customGray-400">
						...
						<div className="inline-flex md:text-base text-sm mb-3 md:mt-5 text-customGray-500 dark:text-customGray-400 ">
						...
						<div className="inline-flex md:text-base text-sm mb-3 md:mt-5 text-customGray-500 dark:text-customGray-400 relative ">
							...
							<TabsComponent>
								<Tabs>
									...
									<TabPanel>
										...
										<div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
											<label className="block md:md:text-sm md:col-span-1 sm:col-span-2 text-xs font-semibold text-customGray-600 dark:text-customGray-400 md:mb-1">
