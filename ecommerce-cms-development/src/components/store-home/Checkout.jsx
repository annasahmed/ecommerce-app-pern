	...
	return (
		<>
			<div className="col-span-12 md:col-span-12 lg:col-span-12 pr-3">
				...
				<div className="inline-flex md:text-lg text-md text-customGray-800 font-semibold dark:text-customGray-400 md:mb-3 mb-1">
					<FiSettings className="mt-1 mr-2" />
					{t("Checkout")}
				</div>
				<hr className="md:mb-12 mb-3" />

				<div className="flex justify-between md:text-base text-sm mb-3  dark:text-customGray-400 relative">
					<div className="w-full text-customGray-500">
				...
				<div className="flex justify-between md:text-base text-sm mb-3 mt-12 dark:text-customGray-400 relative">
					<div className="w-full text-customGray-500">
