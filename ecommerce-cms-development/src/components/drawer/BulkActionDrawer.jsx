		...
		<>
			<Drawer
				...
				<button
					...
					className="absolute z-50 text-customRed-500 hover:bg-customRed-100 hover:text-customGray-700 transition-colors duration-150 bg-customWhite shadow-md mr-6 mt-6 right-0 left-auto w-10 h-10 rounded-full block text-center">
				...
				<div className="flex flex-col w-full h-full justify-between">
					...
					<Scrollbars className="w-full md:w-7/12 lg:w-8/12 xl:w-8/12 relative dark:bg-customGray-700 dark:text-customGray-200">
						<form onSubmit={handleSubmit(onSubmit)} className="block">
							...
							<div className="fixed bottom-0 w-full right-0 py-4 lg:py-8 px-6 grid gap-4 lg:gap-6 xl:gap-6 md:flex xl:flex bg-customGray-50 border-t border-customGray-100 dark:border-customGray-700 dark:bg-customGray-800 dark:text-customGray-300">
								<div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
									<Button
										onClick={toggleBulkDrawer}
										className=" text-customRed-500 hover:bg-customRed-50 hover:border-customRed-100 hover:text-customRed-600 dark:bg-customGray-700 dark:border-customGray-700 dark:text-customGray-500 dark:hover:bg-customGray-800 dark:hover:text-customRed-700"
										layout="outline">
										Cancel
									</Button>
								</div>
