	...
	return (
		<>
			<Modal
				...
				center
				closeIcon={
					<div className="absolute top-0 right-0 text-customRed-500 focus:outline-none active:outline-none text-xl border-0">
			...
			<div
				...
				className="flex justify-center text-center cursor-pointer text-customGray-400 hover:text-customTeal-600">
				{" "}
				<Tooltip
					id="view"
					Icon={FiZoomIn}
