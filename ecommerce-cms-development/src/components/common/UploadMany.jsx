			...
			<div className="flex">
				<div ref={dRef} className="lg:flex-1 md:flex-1 mr-3 sm:flex-none">
					{(title === "Products" ||
						...
						<button
							...
							className="border flex justify-center items-center border-customGray-300 hover:border-customTeal-400 hover:text-customTeal-400  dark:text-customGray-300 cursor-pointer h-10 w-20 rounded-md focus:outline-none">
					...
					{dropDown && (
						<ul
							className="origin-top-left absolute  w-56 rounded-md shadow-lg bg-customWhite dark:bg-customGray-800 focus:outline-none z-40"
							style={{}}>
				...
				<div className="lg:flex-1 md:flex-1 mr-3  sm:flex-none">
					<button
						...
						className="border flex justify-center items-center h-10 w-20 hover:text-customOrange-400  border-customGray-300 dark:text-customGray-300 cursor-pointer  py-2 hover:border-customOrange-400 rounded-md focus:outline-none">
			...
			{isImportBoxShown && (
				<>
					<div className="w-full my-2 lg:my-0 md:my-0 flex">
						<div className="h-10 border border-dashed border-customTeal-500 rounded-md">
							<label className="w-full rounded-lg h-10 flex justify-center items-center text-xs dark:text-customGray-400 leading-none">
								<Input
									disabled={isDisabled}
									type="file"
									accept=".csv,.xls,.json"
								...
								{filename ? (
									...
									<>
										<FiUploadCloud className="mx-2 text-customTeal-500 text-lg dark:text-customGray-400" />{" "}
								...
								{filename && (
									<span
										...
										type="button"
										className="text-customRed-500 focus:outline-none mx-4 text-lg">
										<FiXCircle />
									</span>
								)}
							</label>
