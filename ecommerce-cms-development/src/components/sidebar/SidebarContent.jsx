					...
					route.routes ? (
						...
						<li className="relative" key={route.name}>
							<NavLink
								...
								className="px-6 py-4 inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-customTeal-700 dark:hover:text-customGray-200"
								// activeClassName="text-customTeal-500 dark:text-customGray-100"
								activeStyle={{
									color: "#0d9e6d",
								}}
								rel="noreferrer">
