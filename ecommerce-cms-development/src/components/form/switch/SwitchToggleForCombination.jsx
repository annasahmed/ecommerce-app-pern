		...
		<>
			<div
				...
				<div className="flex flex-wrap items-center">
					{product ? (
						<label className="block text-base font-normal text-customOrange-500 dark:text-customOrange-400 mx-4">
							{t("ThisProductHaveVariants")}
						</label>
					) : (
						<label className="block text-sm font-semibold text-customGray-700 dark:text-customGray-300 mb-1">
							{title}
						</label>
					)}
