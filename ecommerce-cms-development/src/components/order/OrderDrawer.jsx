...
const OrderDrawer = ({ id, data }) => {
	...
	const onSubmit = async (data) => {
		try {
			...
			if (id) {
				const res = await OrderServices.updateOrder(id, orderData);
				setIsUpdate(true);
	...
	return (
		<>
			<DrawerHeader
				id={id}
				register={register}
				updateTitle={t("UpdateOrder")}
				updateDescription={t("UpdateOrderDescription")}
				addTitle={t("AddOrderTitle")}
				addDescription={t("AddOrderDescription")}
			/>
