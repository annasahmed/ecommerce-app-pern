	...
	return (
		<>
			...
			{!error && !loading && dataTable.length === 0 && (
				<div className="w-full bg-customWhite rounded-md dark:bg-customGray-800">
					<div className="p-8 text-center">
						<span className="flex justify-center my-30 text-customRed-500 font-semibold text-6xl">
							<IoBagHandle />
						</span>
						<h2 className="font-medium text-base mt-4 text-customGray-600">
