			...
			<AnimatedContent>
				<div className="flex items-center pb-4">
					<ol className="flex items-center w-full overflow-hidden font-serif">
						<li className="text-sm pr-1 transition duration-200 ease-in cursor-pointer hover:text-customTeal-500 font-semibold">
							<Link className="text-customBlue-700" to={`/attributes`}>
								Attributes
							</Link>
						</li>

						<span className="flex items-center font-serif dark:text-customGray-400">
							<li className="text-sm mt-[1px]">
								{" "}
								<FiChevronRight />{" "}
							</li>

							<li className="text-sm pl-1 font-semibold dark:text-customGray-400">
				...
				<Card className="min-w-0 shadow-xs overflow-hidden bg-customWhite dark:bg-customGray-800 mb-5">
					<CardBody className="py-3 grid gap-4 justify-end lg:gap-4 xl:gap-4 md:flex xl:flex">
						...
						<Button
							...
							className="rounded-md h-12 bg-customRed-500">
							<span className="mr-3">
								<FiTrash2 />
							</span>
							Delete
