...
const StoreHome = () => {
	...
	return (
		<>
			...
			<>
				<ul className="sm:flex grid grid-cols-3 text-sm font-medium text-center text-customGray-500 sm:divide-x divide-customGray-200 rounded-lg dark:divide-customGray-700 dark:text-customGray-400 mb-5">
					<li>
						<Link
							...
							className={`inline-block w-full px-4 py-3 shadow-md ${
								tabName === "home-settings" || location.search === ""
									? "bg-customTeal-500 text-customWhite dark:bg-customTeal-500 dark:text-customWhite"
									: "bg-customGray-200 text-customGray-800 font-medium dark:bg-customGray-600 dark:text-customGray-300"
							} hover:text-customWhite hover:bg-customTeal-500  focus:outline-none dark:hover:text-customWhite dark:hover:bg-customTeal-500 sm:rounded-l-md rounded-tl-md`}>
						...
						<Link
							...
							className={`inline-block w-full py-3 px-4 shadow-md ${
								tabName === "single-setting"
									? "bg-customTeal-500 text-customWhite dark:bg-customTeal-500 dark:text-customWhite"
									: "bg-customGray-200 text-customGray-800 font-medium dark:bg-customGray-600 dark:text-customGray-300"
							} hover:text-customWhite hover:bg-customTeal-500  focus:outline-none dark:hover:text-customWhite dark:hover:bg-customTeal-500`}>
							<span className="text-sm font-medium font-serif xl:inline-block hidden">
								{t("SingleSetting")}
							</span>
							<span className="text-sm font-medium font-serif xl:hidden">
						...
						<Link
							...
							className={`inline-block w-full py-3 px-4 shadow-md ${
								tabName === "about-us-setting"
									? "bg-customTeal-500 text-customWhite dark:bg-customTeal-500 dark:text-customWhite"
									: "bg-customGray-200 text-customGray-800 font-medium dark:bg-customGray-600 dark:text-customGray-300"
							} hover:text-customWhite hover:bg-customTeal-500 focus:outline-none dark:hover:text-customWhite dark:hover:bg-customTeal-500 sm:rounded-tr-none rounded-tr-md`}>
							<span className="text-sm font-medium font-serif xl:inline-block hidden">
								{t("AboutUsSetting")}
							</span>
							<span className="text-sm font-medium font-serif xl:hidden">
						...
						<Link
							...
							className={`inline-block w-full py-3 px-4 shadow-md ${
								tabName === "contact-us-setting"
									? "bg-customTeal-500 text-customWhite dark:bg-customTeal-500 dark:text-customWhite"
									: "bg-customGray-200 text-customGray-800 font-medium dark:bg-customGray-600 dark:text-customGray-300"
							} hover:text-customWhite hover:bg-customTeal-500  focus:outline-none dark:hover:text-customWhite dark:hover:bg-customTeal-500 sm:rounded-bl-none rounded-bl-md`}>
							<span className="text-sm font-medium font-serif xl:inline-block hidden">
								{t("ContactUsStting")}
							</span>
							<span className="text-sm font-medium font-serif xl:hidden">
				...
				{(tabName === "home-settings" || tabName === null) && (
					<AnimatedContent>
						<div className="sm:container md:p-6 p-4 mx-auto bg-customWhite dark:bg-customGray-800 dark:text-customGray-200 rounded-lg">
				...
				{tabName === "FAQ-setting" && (
					<AnimatedContent>
						<div className="sm:container md:p-6 p-4 mx-auto w-full bg-customWhite  dark:bg-customGray-800 dark:text-customGray-200 rounded-lg">
							<form onSubmit={handleSubmit(onSubmit)}>
								<Faq
									isSave={isSave}
									errors={errors}
				...
				{tabName === "contact-us-setting" && (
					<AnimatedContent>
						<div className="sm:container md:p-6 p-4 w-full mx-auto bg-customWhite  dark:bg-customGray-800 dark:text-customGray-200 rounded-lg">
							<form onSubmit={handleSubmit(onSubmit)}>
								<ContactUs
									isSave={isSave}
									errors={errors}
