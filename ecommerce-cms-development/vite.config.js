	...
	plugins: [
		...
		VitePWA({
			...
			manifest: {
				...
				start_url: ".",
				id: ".",
				short_name: "EComStore - E-Commerce Website",
				name: "EComStore | React eCommerce Admin Dashboard",
				description:
					"EComStore : React Grocery & Organic Food Store e-commerce Admin Dashboard",
				icons: [
					{
						src: "favicon.ico",
						sizes: "48x48",
