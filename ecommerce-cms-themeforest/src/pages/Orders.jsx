	...
	return (
		<>
									...
									{loadingExport ? (
										...
										<button
											...
											className={`${
												...
												"opacity-50 cursor-not-allowed bg-customTeal-600"
											} flex items-center justify-center text-sm leading-5 h-12 w-full text-center transition-colors duration-150 font-medium px-6 py-2 rounded-md text-customWhite bg-customTeal-500 border border-transparent active:bg-customTeal-600 hover:bg-customTeal-600 `}>
											Download All Orders
							...
							<div className="grid gap-4 lg:gap-6 xl:gap-6 lg:grid-cols-3 xl:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 py-2">
								...
								<div className="mt-2 md:mt-0 flex items-center xl:gap-x-4 gap-x-1 flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
									<div className="w-full mx-1">
										...
										<Button
											type="submit"
											className="h-12 w-full bg-customTeal-700">
											Filter
										</Button>
									</div>
									...
									<div className="w-full">
										...
										<Button
											...
											type="reset"
											className="px-4 md:py-1 py-3 text-sm dark:bg-customGray-700">
					...
					<CardBody>
						<div className="flex gap-1">
							{data?.methodTotals?.map((el, i) => (
								<div key={i + 1} className="dark:text-customGray-300">
									{el?.method && (
										<>
			...
			{loading ? (
				...
				<TableContainer className="mb-8 dark:bg-customGray-900">
					<Table>
						<TableHeader>
							<tr>
