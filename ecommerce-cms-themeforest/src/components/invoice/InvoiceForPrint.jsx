					...
					<div className="mb-8" key={i + 1}>
						...
						<TableContainer className="my-4 rounded-b-lg">
							<Table>
								<TableHeader>
									<tr>
										<TableCell className="bg-customWhite">
											<span className="text-xs capitalize text-customGray-700">
												{t("Item")}
											</span>
										</TableCell>
										<TableCell className="text-xs bg-customWhite capitalize text-center text-customGray-700">
											{t("QTY")}
										</TableCell>
										<TableCell className="text-xs bg-customWhite capitalize text-right text-customGray-700">
											{t("Amount")}
										</TableCell>
									</tr>
								</TableHeader>
								<TableBody className="bg-customWhite dark:bg-customGray-800 divide-y divide-customGray-100 text-serif text-sm">
									{or?.cart?.map((item, i) => (
										<TableRow
											key={i}
											className="dark:border-customGray-700 dark:text-customGray-400 bill">
											<TableCell className="py-1">
												<span className="font-normal text-customGray-600 bill">
													{" "}
											...
											<TableCell className="text-right py-1">
												<span className="text-right font-bold text-customGray-700 bill">
													{" "}
													{currency}
							...
							<div className="flex justify-between -mt-3 mr-1 mb-4">
								<div className="mt-2">
									{or?.paymentMethod === "Combined" ? (
										<p className="bill">
											<span className="mb-1 font-semibold bill font-serif text-xs text-customGray-700 dark:text-customGray-500 block">
												{t("Paymentmethod")} :{" "}
												<span className="text-customGray-600 bill">
													{or.paymentMethod}
												</span>
											</span>
										...
										<p className="bill">
											<span className="font-semibold bill font-serif text-xs text-customGray-600 dark:text-customGray-500 block">
												{t("Paymentmethod")} :{" "}
												<span className="text-customGray-700 bill">
													{or.paymentMethod}
												</span>
											</span>
										</p>
									...
									<div className="text-xs bill">
										{or?.shippingOption && (
											<>
												<span className="text-customGray-600">
										...
										<span className="text-customGray-600">
											{t("Date")} :{" "}
											<span className="font-semibold text-customGray-700">
												{" "}
								...
								<div className="mt-2">
									...
									<h3 className="flex justify-between font-medium text-xs border-t border-customBlack mt-2">
										<span> {t("Total")} : </span>
										<span className="font-semibold ">
											{currency}
