			...
			{shouldShowNavigation && (
				<>
					<div
						...
						} top-1/2 transform -translate-y-1/2 z-10 cursor-pointer text-light bg-secondary hover:brightness-95 shadow-md rounded-full p-1 max-md:p-0.5 text-xl select-none`}>
						<ChevronRight className="rotate-180 size-6 max-md:size-3" />
					</div>
					<div
						ref={nextRef}
						className={`absolute ${
						...
						<ChevronRight className="size-6 max-md:size-3" />
					</div>
				</>
			)}
		</div>
